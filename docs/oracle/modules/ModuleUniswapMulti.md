...
Module Contract that is going to be used to help compute Uniswap prices

*This contract will help for an oracle using multiple UniswapV3 poolsAn oracle using Uniswap is either going to be a `ModuleUniswapSingle` or a `ModuleUniswapMulti`*
