...
*This contract helps for an oracle using a Chainlink circuit composed of multiple poolsAn oracle using Chainlink is either going to be a `ModuleChainlinkSingle` or a `ModuleChainlinkMulti`*
