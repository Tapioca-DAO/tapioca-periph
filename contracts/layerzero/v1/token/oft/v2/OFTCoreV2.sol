...
abstract contract OFTCoreV2 is NonblockingLzApp {
    ...
    function _estimateSendAndCallFee(
        ...
        bytes memory payload =
            _encodeSendAndCallPayload(msg.sender, _toAddress, _ld2sd(_amount), _payload, _dstGasForCall);
        return lzEndpoint.estimateFees(_dstChainId, address(this), payload, _useZro, _adapterParams);
    }
    ...
    function _encodeSendAndCallPayload(
        ...
        return abi.encodePacked(
            PT_SEND_AND_CALL, _toAddress, _amountSD, _addressToBytes32(_from), _dstGasForCall, _payload
        );
    }
