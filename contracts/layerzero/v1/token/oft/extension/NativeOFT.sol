...
contract NativeOFT is OFT, ReentrancyGuard {
    ...
    function _debitFromNative(address _from, uint16, bytes memory, uint256 _amount)
        internal
    ...
    function _creditTo(uint16, address _toAddress, uint256 _amount) internal override(OFT) returns (uint256) {
