...
contract ProxyONFT1155 is ONFT1155Core, IERC1155Receiver {
    ...
    function onERC1155Received(address _operator, address, uint256, uint256, bytes memory)
        public
        virtual
        override
        returns (bytes4)
    ...
    function onERC1155BatchReceived(address _operator, address, uint256[] memory, uint256[] memory, bytes memory)
        public
        virtual
        override
        returns (bytes4)
