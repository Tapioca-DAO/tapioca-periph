...
contract SDaiOracle is ITapiocaOracle, SequencerCheck, AccessControlDefaultAdminRules, ReentrancyGuard {
    AggregatorInterface private immutable sDaiOracle;

    constructor(AggregatorInterface _sDaiOracle, address _sequencerUptimeFeed, address _admin)
    ...
    function _get() internal view returns (uint256) {
        return sDaiOracle.latestAnswer(true) * 1e10; // Chainlink returns 8 decimals, we need 18
    }
